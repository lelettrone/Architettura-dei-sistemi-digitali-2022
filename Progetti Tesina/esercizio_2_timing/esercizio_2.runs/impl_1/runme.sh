...
HD_PWD='C:/Users/raimo/Desktop/esercizio_2_timing/esercizio_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log encoder_timing.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source encoder_timing.tcl -notrace
