...
HD_PWD='C:/Users/raimo/Desktop/esercizio_2_timing/esercizio_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log encoder_timing.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source encoder_timing.tcl
