...
HD_PWD='C:/Users/eleun/Desktop/ese_da_scrivere/esercizio_5_board_1_2/esercizio_5_board.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cronometroOnDisplay.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cronometroOnDisplay.tcl -notrace
