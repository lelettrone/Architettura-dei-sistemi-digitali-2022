...
HD_PWD='C:/Users/eleun/Desktop/ese_da_scrivere/esercizio_5_board_1_2/esercizio_5_board.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cronometroOnDisplay.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cronometroOnDisplay.tcl
