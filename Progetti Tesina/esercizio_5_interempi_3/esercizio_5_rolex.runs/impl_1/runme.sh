...
HD_PWD='C:/Users/eleun/Desktop/ese_da_scrivere/esercizio_5_interempi_3/esercizio_5_rolex.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rolex.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rolex.tcl -notrace
