...
HD_PWD='C:/Users/eleun/Desktop/ese_da_scrivere/esercizio_5_interempi_3/esercizio_5_rolex.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rolex.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rolex.tcl
