...
HD_PWD='C:/Users/eleun/Downloads/Progetto_Emanuele_Riccio - 3 FUNZIONA/Progetto_Emanuele_Riccio.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SystemAB.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SystemAB.tcl
